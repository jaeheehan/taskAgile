...
public class BoardServiceImpl implements BoardService {
    ...
    public Board findById(BoardId boardId) {
        return boardRepository.findById(boardId.value()).orElseThrow(EntityNotFoundException::new);
    }
    ...
    public User addMember(BoardId boardId, String usernameOrEmailAddress) throws UserNotFoundException {
        ...
        boardMemberRepository.save(BoardMember.create(boardId, new UserId(user.getId())));
